...
app.controller('sampleAppCtrl', ['$scope', 'sampleAppSensorService',
  function($scope, sampleAppSensorService, $window, $location) {
    ...
    $scope.startSession = function() {
      ...
      sessionEvent.setEventTime(currentTimeMillis);
    ...
    $scope.navigateToPage = function() {
      ...
      navigationEvent.setEventTime(currentTimeMillis);
    ...
    $scope.addTagsToPage = function(tags) {
      ...
      tagAnnotationEvent.setEventTime(currentTimeMillis);
    ...
    $scope.startQuiz = function() {
      ...
      assessmentEvent.setEventTime(currentTimeMillis);
    ...
    $scope.gradeQuiz = function() {
      ...
      outcomeEvent.setEventTime(currentTimeMillis);
